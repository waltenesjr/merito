...
class Application_Model_DbTable_TabelaAvaliacoesJustificativas extends Zend_Db_Table
{

    protected $_name = 'justificativas';
    protected $_schema = '';
    ...
    public function getId($parametros){
        try{
            $select = $this
                ...
                ->where("a.fk_tabela_avaliacoes_id = ?",$parametros["fk_tabela_avaliacoes_id"]);
    ...
    public function getDados($fk_tabela_avaliacoes_id){
        try{
            $select = $this
                ...
                ->where("a.fk_tabela_avaliacoes_id = ?",$fk_tabela_avaliacoes_id);
